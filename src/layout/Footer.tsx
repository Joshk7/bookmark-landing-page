...
const Footer = () => {
  return (
    <footer className="w-full py-8 bg-[var(--blue-950)] flex justify-center">
      <div className="md:w-[75%] flex flex-col md:flex-row items-center justify-between gap-y-12">
        <img
          ...
          alt="Bookmark"
        />
        <ul className="flex flex-col md:flex-row items-center gap-y-6 gap-x-6 mr-auto">
          <li>
            <a
        ...
        <ul className="flex gap-x-10 md:gap-x-6">
          <li>
            <a href="#facebook">
