      ...
      <ul className="mx-auto flex flex-wrap pt-10 px-4 gap-y-10 gap-x-2">
        <li className="mx-auto flex flex-col">
          <img
            ...
            alt=""
          />
          <h2 className="text-center mb-2 text-2xl font-medium leading-loose sm:text-[1.25rem] sm:tracking-[0.015625rem] sm:leading-[120%]">
            Add to Chrome
          </h2>
          <p className="text-center mb-6 text-[0.9375rem] leading-[185%] opacity-50 sm:text-[0.875rem] sm:leading-[200%]">
            Minimum version 62
          </p>
