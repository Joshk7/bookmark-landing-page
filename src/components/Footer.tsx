...
export default function Footer() {
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-4 flex-col text-center md:flex-row md:justify-between">
        ...
        <div>
          <p className="attribution mt-10">
            ...
            . Coded by{" "}
            <a
              href="https://joshuakahlbaugh.pages.dev"
              rel="noreferrer"
              target="_blank"
            >
              Josh Kahlbaugh
